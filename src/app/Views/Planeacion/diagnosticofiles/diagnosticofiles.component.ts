...
@Component({
  selector: 'app-diagnosticofiles',
  templateUrl: './diagnosticofiles.component.html',
  styleUrls: ['./diagnosticofiles.component.css']
})
export class DiagnosticofilesComponent implements OnInit {
